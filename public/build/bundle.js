...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-15ul2hc");
    			add_location(img, file$1, 64, 12, 1134);
    			attr_dev(div0, "class", "thumb svelte-15ul2hc");
    			add_location(div0, file$1, 63, 8, 1102);
    			attr_dev(h1, "class", "svelte-15ul2hc");
    			add_location(h1, file$1, 67, 12, 1236);
    			attr_dev(h2, "class", "svelte-15ul2hc");
    			add_location(h2, file$1, 68, 12, 1268);
    			attr_dev(div1, "class", "user-data svelte-15ul2hc");
    			add_location(div1, file$1, 66, 8, 1200);
    			attr_dev(header, "class", "svelte-15ul2hc");
    			add_location(header, file$1, 62, 4, 1085);
    			add_location(p, file$1, 72, 8, 1352);
    			attr_dev(div2, "class", "description svelte-15ul2hc");
    			add_location(div2, file$1, 71, 4, 1318);
    			attr_dev(div3, "class", "contact-card svelte-15ul2hc");
    			add_location(div3, file$1, 61, 0, 1054);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['userName', 'title', 'description', 'userImage'];
    	...
    	$$self.$capture_state = () => ({ userName, title, description, userImage });
    	...
    	return [userName, title, description, userImage];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 32, 0, 477);
    			add_location(button0, file, 33, 0, 504);
    			add_location(button1, file, 34, 0, 559);
    			attr_dev(input0, "type", "text");
    			input0.value = /*name*/ ctx[0];
    			add_location(input0, file, 35, 0, 612);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 36, 0, 670);
    			attr_dev(input2, "type", "text");
    			add_location(input2, file, 37, 0, 710);
    			attr_dev(input3, "type", "text");
    			add_location(input3, file, 38, 0, 751);
    			attr_dev(textarea, "rows", "3");
    			add_location(textarea, file, 39, 0, 796);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input2, /*title*/ ctx[1]);
    			insert_dev(target, t10, anchor);
    			insert_dev(target, input3, anchor);
    			set_input_value(input3, /*userImage*/ ctx[3]);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*increamentAge*/ ctx[5], false, false, false, false),
    					listen_dev(button1, "click", /*changeName*/ ctx[6], false, false, false, false),
    					listen_dev(input0, "input", /*inputName*/ ctx[7], false, false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*upperCase*/ 16) set_data_dev(t1, /*upperCase*/ ctx[4]);
    			...
    			if (dirty & /*title*/ 2 && input2.value !== /*title*/ ctx[1]) {
    				set_input_value(input2, /*title*/ ctx[1]);
    			}

    			if (dirty & /*userImage*/ 8 && input3.value !== /*userImage*/ ctx[3]) {
    				set_input_value(input3, /*userImage*/ ctx[3]);
    			}
    			...
    			if (dirty & /*title*/ 2) contactcard_changes.title = /*title*/ ctx[1];
    			if (dirty & /*userImage*/ 8) contactcard_changes.userImage = /*userImage*/ ctx[3];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function increamentAge() {
    		$$invalidate(8, age = age + 1);
    	}

    	function changeName() {
    		$$invalidate(0, name = "Ishwardas");
    	}
    	...
    	$$self.$$.on_mount.push(function () {
    		...
    		if (description === undefined && !('description' in $$props || $$self.$$.bound[$$self.$$.props['description']])) {
    			console_1.warn("<App> was created without expected prop 'description'");
    		}

    		if (userImage === undefined && !('userImage' in $$props || $$self.$$.bound[$$self.$$.props['userImage']])) {
    			console_1.warn("<App> was created without expected prop 'userImage'");
    		}
    	});

    	const writable_props = ['name', 'title', 'age', 'description', 'userImage'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('title' in $$props) $$invalidate(1, title = $$props.title);
    		if ('age' in $$props) $$invalidate(8, age = $$props.age);
    		if ('description' in $$props) $$invalidate(2, description = $$props.description);
    		if ('userImage' in $$props) $$invalidate(3, userImage = $$props.userImage);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('description' in $$props) $$invalidate(2, description = $$props.description);
    		if ('userImage' in $$props) $$invalidate(3, userImage = $$props.userImage);
    		if ('upperCase' in $$props) $$invalidate(4, upperCase = $$props.upperCase);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*name*/ 1) {
    			$$invalidate(4, upperCase = name.toUpperCase());
    		}
